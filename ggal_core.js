...
function showTab(name){
  ['chain','strategy','control','calc','ivsmile','ivcalc','histdata','mariposa','analisis','promedio','ratios','tutoriales'].forEach(t=>{
    const el=document.getElementById('tab-'+t);
    if(el)el.style.display=t===name?'block':'none';
  });
  document.querySelectorAll('.tab').forEach((t,i)=>{
    t.classList.toggle('active',['chain','strategy','control','calc','ivsmile','ivcalc','histdata','mariposa','analisis','promedio','ratios','tutoriales'][i]===name);
  });
