...
function showTab(name){
  ['chain','strategy','control','calc','ivsmile','ivcalc','histdata','mariposa'].forEach(t=>{
    document.getElementById('tab-'+t).style.display=t===name?'block':'none';
  });
  document.querySelectorAll('.tab').forEach((t,i)=>{
    t.classList.toggle('active',['chain','strategy','control','calc','ivsmile','ivcalc','histdata','mariposa'][i]===name);
  });
